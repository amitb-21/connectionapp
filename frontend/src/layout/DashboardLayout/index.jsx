                ...
                <div className={styles.homeContainer}>
                    <div className={styles.cover}>
                        ...
                        <div 
                            ...
                            className={`${styles.sidebarOption} ${currentPath === '/dashboard' ? styles.active : ''}`}
                        >
                        ...
                        <div 
                            ...
                            className={`${styles.sidebarOption} ${currentPath === '/discover' ? styles.active : ''}`}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                        ...
                        <div 
                            ...
                            className={`${styles.sidebarOption} ${currentPath === '/my_connections' ? styles.active : ''}`}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
